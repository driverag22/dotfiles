...
(custom-set-variables
 ...
 '(package-selected-packages
   '(golden-ratio magit evil-nerd-commenter counsel-projectile company-box projectile company general which-key org-roam monokai-pro-theme evil use-package haki-theme)))
(custom-set-faces
