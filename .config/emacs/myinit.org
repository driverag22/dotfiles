...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
      '(
        ...
        ("h" "honors" plain (file+headline "tasks.org" "CCPS Honors")
...
#+BEGIN_SRC emacs-lisp
    ...
    (setq org-agenda-custom-commands
        '((" " "Agenda"
           (
            (tags-todo "algorithms|linOpt|mathStats"
             ((org-agenda-overriding-header "Algo. || Lin. Opt. || Math. Stats."))
            )
            (tags-todo "honors|researchProject"
    ...
    (local-set-key (kbd "C-c o") 'cfw:open-org-calendar)
    )
...
*** calfw (calendar)
#+BEGIN_SRC emacs-lisp
(defun my-calendar-entry-comparator (entry1 entry2)
  "Compare two calendar entries by due date and time."
  (let ((due-date1 (calendar-extract-entries entry1 '(:year :month :day :hour :minute)))
        (due-date2 (calendar-extract-entries entry2 '(:year :month :day :hour :minute))))
    (calendar-date-compare due-date1 due-date2)))
   
(use-package calfw
   :defer t
   :bind ("C-c o" . my-calendar)
