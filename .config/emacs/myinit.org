...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
      '(
        ("g" "graphTheory" plain (file+headline "tasks.org" "Graph Theory")
         "** TODO [#%^{Priority}] [GT]%? %(org-set-tags \"GT\")")
        ...
        ("r" "resProj" plain (file+headline "tasks.org" "Research Project - graph theory spring")
